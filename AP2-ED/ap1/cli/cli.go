...
func opcoes() {
	...
	fmt.Println("9 - Atualizar preço de um produto;")
	fmt.Println("10 - Exibir produtos ordenados por nome")
...
func atualizarPrecoProduto() {
	...
	if produtos.AtualizarPrecoProduto(id, novoPreco) {
